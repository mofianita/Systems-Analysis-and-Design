...
//    static final String DB_URL = "jdbc:mysql://localhost:3306/missa?allowPublicKeyRetrieval=true&useSSL=false";
	static final String DB_URL = "jdbc:mysql://localhost:3306/sa_v1"; /* 待改 */

	/** USER常數，所要使用之資料庫使用者帳號 */
	static final String USER = "root"; /* 待改 */

	/** PASS常數，所要使用之資料庫使用者密碼 */
	static final String PASS = ""; /* 待改 */
	...
	/**
	 * 關閉所有資料庫連線與釋放SQL資源，執行一個不返回結果集的 SQL 操作
	 *
	 * @param stm  SQL查詢之指令
	 * @param conn 資料庫之連線
	 */
	...
	/**
	 * 關閉所有資料庫連線與釋放SQL資源，特別關閉有結果集的SQL查詢
	 *
	...
	/** 使用指定的delimiter將String轉為Array輸出 **/
